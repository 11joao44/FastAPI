...
Revision ID: c541e23fc393
Revises: 
Create Date: 2024-07-03 20:20:45.492108
...
def upgrade() -> None:
    ...
    sa.Column('create_c', sa.DateTime(), nullable=False),
    ...
    sa.Column('centros_treinamento_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['categoria_id'], ['categorias.pk_id'], ),
    sa.ForeignKeyConstraint(['centros_treinamento_id'], ['centros_treinamento.pk_id'], ),
    sa.PrimaryKeyConstraint('pk_id'),
